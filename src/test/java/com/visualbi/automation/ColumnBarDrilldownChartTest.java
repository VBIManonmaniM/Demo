...
public void ztlSetterScriptTest(JSONObject setterJSON,JSONObject defaultValueJSON,JSONObject getterReverseJSON,String componentName) throws Exception{
   ...
   public void testDataSelection(Map<String, Property> propertyMap, String componentName){
	   columnBarDrilldownChartPage.go(componentName);
	   testDataSelection(propertyMap,columnBarDrilldownChartPage);
   }
    ...
    columnBarDrilldownChartPage.go(componentName);
    testDataSeriesLabels(propertyMap,columnBarDrilldownChartPage);
    }
   ...
   public void testDataSeriesColor(Map<String, Property> propertyMap, String componentName) throws InterruptedException{
	   columnBarDrilldownChartPage.go(componentName);
	   testDataSeriesColor(propertyMap,columnBarDrilldownChartPage);
   }
   ...
   @VBITestConfig(properties ={
		   ...
		   @VBIProperty(name= Properties.DataSeriesHierarcyLables.COLOR,value = Colors.BLACK_HEX,expectedValue = "#666666"),
		   @VBIProperty(name= Properties.DataSeriesHierarcyLables.FONTSIZE,value = Count.TEN,expectedValue = "11px"),
		   @VBIProperty(name= Properties.DataSeriesHierarcyLables.SHOWTOTALS,value= "X",expectedValue = "Total"),
		   @VBIProperty(name= Properties.DataSeriesHierarcyLables.SHOWTOTAL,value= "",expectedValue = "")
   ...
   public void testDataSeriesShowTotal(Map<String, Property> propertyMap, String componentName){
	   columnBarDrilldownChartPage.go(componentName);
	   testDataSeriesShowTotal(propertyMap,columnBarDrilldownChartPage);
   ...
   public void testDataSeriesShowTotalDatabase(Map<String, Property> propertyMap, String componentName){
	   columnBarDrilldownChartPage.go(componentName);
	   testDataSeriesShowTotalDatabase(propertyMap,columnBarDrilldownChartPage);
   ...
   public void testDataSeriesHierarchyLabel(Map<String, Property> propertyMap, String componentName){
	   columnBarDrilldownChartPage.go(componentName);
	   testDataSeriesHierarchyLabel(propertyMap,columnBarDrilldownChartPage);
   }
}
