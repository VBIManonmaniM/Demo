 ...
 */
 ...
 public class PieDrilldownChartPage extends HighchartsPage {
    ...
    @FindBy(css=".highcharts-legend-item.highcharts-pie-series.highcharts-color-0 > span")
   ...
   public CustomFluentWebElementComponent highchartsTotalTextDB()    {       return highchartsTotalTextDB.as(CustomFluentWebElementComponent.class);    }
