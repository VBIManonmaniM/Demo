 ...
 */
 ...
 public class SemicircledonutChartPage extends HighchartsPage {

 @FindBy(css=".highcharts-series.highcharts-series-0.highcharts-pie-series.highcharts-color-undefined.highcharts-tracker > path.highcharts-point.highcharts-color-0")
 ...
 @FindBy(css=".highcharts-legend-item.highcharts-pie-series.highcharts-color-0 > rect")
 ...
 @FindBy(css=".highcharts-data-labels.highcharts-series-0 span")
